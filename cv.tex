...
Cacti monitoring software
    \item scripting in Bash and Python for monitoring and automatization purposes, for example extracting data from log
files
    \item basic router/switch/DSLAM configuration, backuping network device configurations using scripts
...
\begin{itemize}
    \setlength\itemsep{0.1cm}
    \item Linux systems administration, including email systems, backups systems, monitoring systems, DHCP and DNS services, LDAP, virtualization, web servers, load balancers, proxy servers
    ...
    \item supporting devops ecosystem applications: Jenkins, Nexus, gitlab-ci, Sonarqube, Red Hat Openshift
    ...
    \item ongoing and proactive education in the segment of system administration, devops thinking
...
Computer forensics, strong emphasis on understanding how "things" work behind "curtain".
...
Always looking to learn more in the field of Information Technologies.
\end{document}